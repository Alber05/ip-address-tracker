...
export default function Info() {
  ...
  return (
    <div className='absolute bottom-0 z-30 flex h-max w-[80%] translate-x-[calc(50vw-50%)] translate-y-[50%] flex-col items-center justify-center gap-2 rounded-xl bg-white p-8 text-center shadow-md md:flex-row md:gap-0'>
